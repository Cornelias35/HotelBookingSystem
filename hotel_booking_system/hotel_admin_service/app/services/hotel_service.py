...
from app.data_models import HotelDB, HotelDTO
...
def add_hotel(db: Session, hotel_create: HotelDTO):
    new_hotel = HotelDB(
        ...
        max_capacity_for_economy=hotel_create.max_capacity_for_economy,
        max_capacity_for_standard=hotel_create.max_capacity_for_standard,
        max_capacity_for_deluxe=hotel_create.max_capacity_for_deluxe
    )
    db.add(new_hotel)
    db.commit()
